...
<head>
	...
	<title>Proveedores | Administración Tacoste</title>
 ...
 <div class="content">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody class="dynamic-data">
                                        <?php
                                            $query_string = "SELECT id_proveedor, nombre, telefono, email,
                                            CONCAT(CONCAT(calle, ' '), CONCAT(CONCAT(numero_ext, ' '), CONCAT(CONCAT(colonia, ' '),
                                            CONCAT(CONCAT(ciudad, ' '), CONCAT(cp, ' ')))))
                                            FROM PROVEEDOR
                                            INNER JOIN DIRECCION ON PROVEEDOR.ID_DIRECCION = DIRECCION.ID_DIRECCION";
    ...
    <script>
        $( window ).load(function() {
            $.post( 'dbrequest.php', { peticion : 'proveedores' })
                .done( function( data ) {
