 ...
 */
$query_string = "SELECT PERSONA.email,
                CONCAT(CONCAT(nombres, ' '), CONCAT(CONCAT(apellido_paterno, ' '), apellido_materno)),
                telefono, num_cuenta, puntos_acumulados,
                CONCAT(CONCAT(calle, ' '), CONCAT(CONCAT(numero_ext, ' '), CONCAT(CONCAT(colonia, ' '),
                CONCAT(CONCAT(ciudad, ' '), CONCAT(cp, ' ')))))
                FROM PERSONA 
                INNER JOIN CLIENTE ON PERSONA.email = CLIENTE.email
                INNER JOIN DIRECCION ON PERSONA.id_direccion = DIRECCION.id_direccion";
...
<head>
	...
	<title>Clientes | Administración Tacoste</title>
...
<div class="sidebar-wrapper">
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Datos de Clientes</a>
                </div>
    ...
    <script>
        $( window ).load(function() {
            $.post( 'dbrequest.php', { peticion : 'clientes' })
                .done( function( data ) {
